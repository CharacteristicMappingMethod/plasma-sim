...
for i = N_maps:-1:1
    ...
    Interpolated_Delta_X = lagrange2d_mixed_boundary_interp(Query_X, Query_V, x, v, Delta_X, order);
    Interpolated_Delta_V = lagrange2d_mixed_boundary_interp(Query_X, Query_V, x, v, Delta_V, order);
