...
if params.method=="CMM-NuFI" && isfield(params, 'refine_factor') && params.Ns==1 % works only for one species
...
for s = 1:params.Ns
    ...
    if params.method == "CMM" || params.method == "CMM-NuFI"
